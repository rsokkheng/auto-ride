...
class FirestoreService
{
    ...
    public function syncDelivery(Delivery $delivery): void
    {
        ...
        $this->set(self::C_BOOKINGS, 'delivery_' . $delivery->id, [
            ...
            'service_option'   => $delivery->service_option ?? 'normal',
            ...
            'dropoff_lat'      => $delivery->dropoff_lat ? (float) $delivery->dropoff_lat : null,
            'dropoff_lng'      => $delivery->dropoff_lng ? (float) $delivery->dropoff_lng : null,
            'fee'              => $delivery->fee,
            'package_amount'   => (int) ($delivery->package_amount ?? 0),
