...
return [
    ...
    */
    ...
    |----------------------------------------------------------------------
    | Score = 100 - (distance_km * distance_weight) - (eta_minutes * eta_weight)
    |             - ((5.0 - rating) * rating_weight), clamped to [0, 100].
    | Higher score = better match. Increase distance_weight/eta_weight to
    | favour proximity/speed; increase rating_weight to favour highly-rated drivers.
    */
    'match_distance_weight' => env('DRIVER_MATCH_DISTANCE_WEIGHT', 6),
    'match_eta_weight'      => env('DRIVER_MATCH_ETA_WEIGHT', 1.5),
